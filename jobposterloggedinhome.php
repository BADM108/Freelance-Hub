        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:ml-6 md:flex md:items-center md:space-x-8">
                    ...
                    <a href="available_freelancers.php" class="text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300 text-sm font-medium">Browse Services</a>                 
                    <a href="How_It_Works_Poster.php" class="text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300 text-sm font-medium">How It Works</a>
                </div>

                <div class="hidden md:ml-6 md:flex md:items-center">
                    <!-- Profile Icon Button -->
                    <button onclick="window.location.href='jobposterdashboard.php';" class="flex items-center justify-center p-2 rounded-full hover:bg-gray-100 transition-colors duration-200 profile-icon" title="Profile">
